<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Templates">Succursales</span></a>
                    <ul class="menu-content">
                         <li>
                        <a class="menu-item" href="<?=RACINE?>succursale/list" data-i18n="Vertical"> <i class="feather icon-list"></i> Liste</a>
                        </li>
                         <!-- <li>
                        <a class="menu-item" href="<?=RACINE?>succursale/ajout" data-i18n="Vertical"> <i class="feather icon-plus"></i> ajouter</a>
                        </li> -->
                    </ul>
                </li>

                <li class=" nav-item"><a href="#"><i class="feather icon-tag"></i><span class="menu-title" data-i18n="Templates">Campagnes</span></a>
                    <ul class="menu-content">
                         <li>
                        <a class="menu-item" href="<?=RACINE?>campagne/list" data-i18n="Vertical"> <i class="feather icon-list"></i> Liste</a>
                        </li>
                    </ul>
                </li>
